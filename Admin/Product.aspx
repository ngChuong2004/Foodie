                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                            ErrorMessage="Descriptions is required" ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:DropDownList ID="ddlCategories" CssClass="form-control" runat="server"
                                                            ...
                                                            AppendDataBoundItems="True" OnSelectedIndexChanged="ddlCategories_SelectedIndexChanged">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                                            ...
                                                            SelectCommand="SELECT [CategoryId], [Name] FROM [Categories]" OnSelecting="SqlDataSource1_Selecting"></asp:SqlDataSource>
                                                    </div>
                                                </div>
